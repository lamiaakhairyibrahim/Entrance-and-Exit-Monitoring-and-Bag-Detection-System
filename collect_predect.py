...
# Open video file
cap = cv2.VideoCapture(r'D:\job_ vision\door\src\all_project\data\video3.mp4')

# --- Video Writer setup ---
frame_width = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
frame_height = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
fps = int(cap.get(cv2.CAP_PROP_FPS))
output_path = r'D:\job_ vision\door\src\all_project\data\output_video3_final_bag_region_lamiaa_predect.mp4'
...
output_dir = r'D:\job_ vision\door\src\all_project\data'
